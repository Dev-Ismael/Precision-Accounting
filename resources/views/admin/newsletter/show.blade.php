    ...
    <div class="py-4 admin-page-info">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.newsletter.index') }}">Mails</a></li>
                        ...
                        <div class="card border-0 shadow">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h2 class="fs-5 fw-bold mb-0"> <i class="fa-solid fa-eye text-primary"></i> Mail Details</h2>
                                    </div>
                                    <div class="col text-end">
                                        <a href="{{ route('admin.newsletter.destroy', $newsletter->id) }}" class="btn btn-sm btn-danger delete-record">
                                ...
                                <table class="table align-items-center table-flush show-data">
                                    <tbody>
                                        {{-- <tr>
                                            ...
                                            <td> {{ $newsletter->id != "" ? $newsletter->id : '-'}} </td>
                                        </tr> --}}
                                        <tr>
