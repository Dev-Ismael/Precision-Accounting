                                ...
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.tax_center.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <!----------------- Content -------------------->
                                            ...
                                            <textarea type="text" name="content" rows="5" class="ckeditor form-control @error('content') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Tax Center Content..." autocomplete="nope" >{{ old('content') }}</textarea>
                                            @error('content')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
